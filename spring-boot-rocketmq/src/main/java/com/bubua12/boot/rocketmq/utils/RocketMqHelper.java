package com.bubua12.boot.rocketmq.utils;
 ...
 *
 * @author bubua12
 * @since 2025/11/28 15:44
 */
@Component
public class RocketMqHelper {
    public static final Logger log = LoggerFactory.getLogger(RocketMqHelper.class);
    ...
    @PreDestroy
    public void destroy() {
        log.info("=== === destroy RocketMqHelper === ===");
    }
}
